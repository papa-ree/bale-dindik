<div>
    <section id="applications" class="py-20 bg-neutral" x-data="appSection({
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-4xl mx-auto mb-10" data-aos="fade-up" data-aos-delay="100">
                <div class="relative mb-6">
                    ...
                    <input type="text" x-model="searchQuery" placeholder="Search applications..."
                        class="w-full pl-12 pr-4 py-4 text-base border border-gray-200 rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all" />
                    <!-- Clear Icon -->
                ...
                <div class="flex flex-wrap gap-3 justify-center">
                    <template x-for="cat in categories" :key="cat">
                        <button @click="selectedCategory = cat"
                            :class="selectedCategory === cat ? 'bg-primary text-white' : 'bg-white text-gray-700 border border-gray-300 hover:border-primary hover:text-primary'"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                ...
                <div x-show="filteredApplications.length === 0"
                    class="bg-white col-span-3 rounded-lg p-8 border border-gray-200 text-center shadow-sm"
                    data-aos="fade-up">
                    <div class="flex flex-col items-center mx-auto w-full gap-4">
                        ...
                        <div class="p-4 bg-red-50 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                class="lucide lucide-circle-off-icon lucide-circle-off text-red-500">
                                <path d="m2 2 20 20" />
                ...
                <template x-if="filteredApplications.length > 0">
                    <template x-for="app in filteredApplications">
                        <a :href="app.url" target="_blank"
                            class="bg-white rounded-lg p-6 border border-gray-200 hover:border-primary hover:shadow-xl transition-all duration-300 cursor-pointer group"
                            data-aos="fade-up">
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <h3 class="font-semibold text-primary mb-1 text-lg capitalize" x-text="app.name">
                                    </h3>
                                    <p class="text-sm text-gray-600 mb-3 capitalize" x-text="app.description"></p>
                                    <span
                                        class="inline-block px-3 py-1 capitalize bg-gray-100 text-gray-700 text-xs rounded-full"
